...
declare namespace AMap {
    ...
    class Geolocation {
        ...
        isSupported(): boolean;
        getCurrentPosition(callback?: (status:any, result:any) => void):void;
        watchPosition(): number;
        clearWatch(watchId: number):void;
        getCityInfo(callback: (status:any, result:any) => void):void;
    }
    ...
    class CitySearch {
        ...
        getCityByIp(ip: String, callback: (status: String, result: CitySearchResult) => void):void;
    }
